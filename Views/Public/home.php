        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-2">
                    ...
                    <li class="nav-item"><a class="btn btn-primary-custom px-3 py-2" href="../Auth/login.php">Log In</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="../Auth/signup.php" class="btn btn-primary-custom btn-lg px-4 py-2 fw-semibold">
                            <i class="bi bi-person-plus me-1"></i> Join as a Patient
                        </a>
                        <a href="../Auth/therapist-register.php" class="btn btn-accent btn-lg px-4 py-2 fw-semibold">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4">
                    <div class="cta-card">
                        ...
                        <a href="../Auth/signup.php" class="btn btn-primary-custom w-100 py-2 fw-semibold">Sign Up</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="cta-card">
                        ...
                        <a href="../Auth/therapist-register.php" class="btn btn-accent w-100 py-2 fw-semibold">Apply Now</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="cta-card">
                        ...
                        <a href="../Auth/login.php" class="btn btn-primary-custom w-100 py-2 fw-semibold">Log In</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2"><a href="../Auth/signup.php">Join as a Patient</a></li>
                        <li class="mb-2"><a href="../Auth/therapist-register.php">Apply as a Therapist</a></li>
                        <li class="mb-2"><a href="../Auth/login.php">Log In</a></li>
