...
<head>
    ...
    <style>
        ...
        /* Highlight Add Therapist link only on this page */
...
<body class="d-flex align-items-center py-5" style="min-height: 100vh;">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse bg-white shadow-sm">
                <div class="position-sticky pt-4">
                    ...
                    <ul class="nav flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="therapist-register.php">
            ...
            <!-- Main Content -->
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 fade-in">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-7 col-xl-6">
                ...
                <div class="card card-custom p-4 p-md-5">
                    <form id="therapistRegForm" action="../../Controllers/FormController.php" method="POST" enctype="multipart/form-data" novalidate>  
                        ...
                        <input type="hidden" name="specialization" id="hiddenSpecialization">
                        <input type="hidden" name="licenseStatus" id="hiddenLicenseStatus">
                        <input type="hidden" name="yearsOfExperience" id="hiddenYearsOfExperience">
                        <input type="hidden" name="availabilitySchedule" id="hiddenAvailabilitySchedule">
                        ...
                        <div class="form-step" id="step2">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select py-2" id="specialization" name="specialization" required>
                                    ...
                                    <option value="Family & Marriage Therapy">Family & Marriage Therapy</option>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-secondary-custom mb-0 small">Already have an account? <a href="login.php" class="text-primary-custom text-decoration-none fw-semibold">Sign In</a></p>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border:none; border-radius:16px;">
                <div class="modal-body text-center p-5">
                    ...
                    <a href="../Public/home.php" class="btn btn-primary-custom w-100 py-2 fw-semibold">Back to Home</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function syncHiddenFields() {
            var fieldMap = {
                ...
                'email': 'hiddenEmail',
                'nationalID': 'hiddenNationalID',
                'city': 'hiddenCity',
                'phone': 'hiddenPhone',
                'dob': 'hiddenDob',
                'gender': 'hiddenGender',
                'specialization': 'hiddenSpecialization',
                'licenseStatus': 'hiddenLicenseStatus',
                'yearsOfExperience': 'hiddenYearsOfExperience',
                'availabilitySchedule': 'hiddenAvailabilitySchedule'
            };
            Object.keys(fieldMap).forEach(function(srcId) {
                var src = document.getElementById(srcId);
                var dst = document.getElementById(fieldMap[srcId]);
        ...
        function validateStep1() {
            syncHiddenFields(); // Sync all form data to hidden fields
        ...
        document.getElementById('therapistRegForm').addEventListener('submit', function(e) {
            // Sync all form data to hidden fields before submission
            syncHiddenFields();
            ...
            // Note: Form will show confirmation modal after successful submission via PHP redirect
        });
    </script>
</body>
</html>
