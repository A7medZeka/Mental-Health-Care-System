        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card card-custom p-4 p-md-5">
                    ...
                    <form action="../../Controllers/FormController.php" id="forgotPasswordForm" method="POST">
                        ...
                        <div class="text-center">
                            <a href="login.php" class="text-primary-custom text-decoration-none small fw-semibold">
