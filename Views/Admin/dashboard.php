...
$userData = $controller->getUserData($_SESSION['user_id']);
...
$totalPendingTherapists = $dashboardData['pending_therapists'];
...
<head>
    ...
    <title>Admin Dashboard - Mental Health Care</title>
    <!-- Bootstrap 5 CSS -->
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-3 flex-wrap">
                                    <a href="patients.php" class="btn btn-primary-custom"><i class="bi bi-arrow-right-circle me-2"></i>Manage Patients</a>
                                    <a href="therapists.php" class="btn btn-primary-custom"><i class="bi bi-arrow-right-circle me-2"></i>Verify Therapists</a>
