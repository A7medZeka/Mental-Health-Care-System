            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card card-custom p-4 p-md-5">
                    ...
                    <form action="handleForms.php" id="signupForm" novalidate>
                        ...
                        <input type="hidden" name="selectedRole" value="patient">
                        ...
                        <div class="form-step active" id="step1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control py-2" id="nationalID" placeholder="Enter your National ID" required name="nationalID">
