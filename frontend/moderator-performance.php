...
<head>
    ...
    <title>Therapist Performance Metrics - MentalCare System</title>
    <meta name="description" content="Aggregated therapist ratings, session feedback, and performance trends dashboard.">
    ...
    <style>
        ...
        .metric-card {
            ...
            background:#fff; box-shadow:0 2px 18px rgba(47,143,126,0.08);
        ...
        .chart-label { width:110px; flex-shrink:0; color:var(--text-brown); font-weight:500;
                       white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        .chart-track { flex:1; background:#e9ecef; border-radius:20px; height:12px; overflow:hidden; }
        .chart-fill  { height:100%; border-radius:20px; background:var(--primary-green);
        ...
        /* ── Donut Indicator (CSS rings) ── */
        .donut-wrap { position:relative; width:90px; height:90px; flex-shrink:0; }
        .donut-wrap svg { transform:rotate(-90deg); }
        .donut-text {
            position:absolute; inset:0;
            display:flex; flex-direction:column; align-items:center; justify-content:center;
            font-weight:700; font-size:1.1rem; color:var(--primary-green);
        }
        .donut-text small { font-size:.6rem; font-weight:500; color:var(--light-brown); }
        ...
        /* ── Feedback List ── */
        .feedback-item {
            padding:.85rem 1rem; border-radius:10px; background:#f8fdf9;
            border:1px solid rgba(47,143,126,0.12); margin-bottom:.6rem;
            font-size:.88rem;
        }
        ...
        /* ── Period Filter ── */
        .period-btn { border-radius:20px; font-size:.82rem; font-weight:600;
                      padding:.3rem .9rem; border:2px solid #dee2e6; background:transparent;
                      color:var(--text-brown); cursor:pointer; transition:all .2s; }
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse bg-white shadow-sm">
            <div class="position-sticky pt-4">
                ...
                <ul class="nav flex-column mb-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="moderator-performance.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 fade-in">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-lg-3">
                    <div class="metric-card d-flex align-items-center gap-3">
                        <div class="metric-icon bg-light-green text-primary-custom">
                        ...
                        <div>
                            ...
                            <div class="star-rating mt-1" id="kpiStars">
                ...
                <div class="col-6 col-lg-3">
                    <div class="metric-card d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 text-primary-custom" id="kpiReviews">284</h3>
                ...
                <div class="col-6 col-lg-3">
                    <div class="metric-card d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 text-primary-custom" id="kpiSessions">612</h3>
                            <small class="text-secondary-custom">this period</small>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="metric-card d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color:#e67e22;" id="kpiNoShow">6.4%</h3>
            ...
            <!-- ── Two-column: Rankings + Detail ── -->
            <div class="row g-4">

                <!-- LEFT: Therapist Rankings -->
                <div class="col-lg-5">
                    <div class="card card-custom h-100">
                        <div class="card-header bg-white border-0 pt-4 pb-0">
                            <h5 class="fw-bold text-primary-custom mb-0">
                                <i class="bi bi-trophy me-2"></i>Therapist Rankings
                            </h5>
                    ...
                    <div class="card card-custom h-100" id="detailPanel">
                        ...
                        <div class="card-body">
                            ...
                            <div class="chart-bar-wrap mb-4" id="ratingBreakdown">
                                <div class="chart-row">
                                    <span class="chart-label"><i class="bi bi-star-fill star-filled me-1" style="font-size:.75rem;"></i>5 Stars</span>
                                    <div class="chart-track"><div class="chart-fill" style="width:72%"></div></div>
                                    <span class="chart-value">72%</span>
                                </div>
                                <div class="chart-row">
                                    <span class="chart-label"><i class="bi bi-star-fill star-filled me-1" style="font-size:.75rem;"></i>4 Stars</span>
                                    <div class="chart-track"><div class="chart-fill" style="width:18%"></div></div>
                                    <span class="chart-value">18%</span>
                                </div>
                                <div class="chart-row">
                                    <span class="chart-label"><i class="bi bi-star-fill star-filled me-1" style="font-size:.75rem;"></i>3 Stars</span>
                                    <div class="chart-track"><div class="chart-fill warn" style="width:7%"></div></div>
                                    <span class="chart-value" style="color:#F4B41A;">7%</span>
                                </div>
                                <div class="chart-row">
                                    <span class="chart-label"><i class="bi bi-star-fill star-filled me-1" style="font-size:.75rem;"></i>2 Stars</span>
                                    <div class="chart-track"><div class="chart-fill danger" style="width:2%"></div></div>
                                    <span class="chart-value" style="color:#dc3545;">2%</span>
                                </div>
                                <div class="chart-row">
                                    <span class="chart-label"><i class="bi bi-star-fill star-filled me-1" style="font-size:.75rem;"></i>1 Star</span>
                                    <div class="chart-track"><div class="chart-fill danger" style="width:1%"></div></div>
                                    <span class="chart-value" style="color:#dc3545;">1%</span>
                                </div>
                            </div>

                            <!-- Key Metrics Row -->
                            <div class="row g-3 mb-4" id="detailKPIs">
                                <div class="col-4">
                                    <div class="text-center p-3 rounded-3 bg-light-green">
                                        <div class="fw-bold text-primary-custom fs-5" id="dKpiSessions">187</div>
                                        <small class="text-secondary-custom">Sessions</small>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-3 rounded-3 bg-light-green">
                                        <div class="fw-bold text-primary-custom fs-5" id="dKpiPatients">34</div>
                                        <small class="text-secondary-custom">Patients</small>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-3 rounded-3" style="background:#fff3cd;">
                                        <div class="fw-bold fs-5" style="color:#e67e22;" id="dKpiNoShow">3.2%</div>
